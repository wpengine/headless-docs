...
1. Install [Query Monitor](https://wordpress.org/plugins/query-monitor/) plugin on your WordPress site.
2. Activate the plugin.
3. Click the Query Monitor that has appear in your WP Admin Top Nav.
4. In the dashboard that appears, clock on "Logs."
5. Run your Atlas Search and see the data appear.
...
You can query fields that appear on the plugin's Search Config page, including ACF fields, ACM fields, tags and categories, etc. Consider the following query:
