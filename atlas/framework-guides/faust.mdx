...
To get started, you can run the following command to create a new Faust.js project and the follow the steps in their [getting started guide](https://faustjs.org/docs/getting-started):
