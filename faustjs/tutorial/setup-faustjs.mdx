---
slug: /faustjs/tutorial/setup-faustjs
...
To install WPE Headless, [download the latest version](https://wp-product-info.wpesvc.net/v1/plugins/wpe-headless?download). Then, upload and activate the plugin from within the WordPress admin panel.
...
Before you can run the `generate` script, you'll need to temporarily enable "Public Introspection" from the WordPress admin panel -> GraphQL Settings:

<img
  src="../assets/img/wpgraphql-introspection.png"
