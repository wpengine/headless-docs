...
**NOTE:** There is a known issue using Local's SSL certificates on MacOS versions Monteray and Big Sur. If you are using one of those versions, you will need to [manually trust the certificates](https://localwp.com/help-docs/ssl/managing-local-sites-ssl-certificate-in-macos/) to use HTTPS.
