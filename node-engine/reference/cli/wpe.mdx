...
- [wpe apps](./wpe/apps)
  - Manage your headless applications
- [wpe auth](./wpe/auth)
  - Authenticate with the WP Engine Headless CLI
- [wpe builds](./wpe/builds)
  - Get build results for your headless
- [wpe context](./wpe/context)
  - Set the account or current app context
- [wpe envs](./wpe/envs)
  - Manage your headless application environments
- [wpe logs](./wpe/logs)
  - View logs for your headless applications
- [wpe completion](./wpe/completion)
  - Load shell completion scripts
