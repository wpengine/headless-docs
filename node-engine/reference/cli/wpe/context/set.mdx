---
slug: /node-engine/reference/cli/wpe/context/set
title: wpe context set
description: Atlas Node Engine API Reference - Set the account context for the WP Engine Headless CLI.
---
