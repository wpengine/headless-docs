...
The steps below are more specific on how to query content models by taxonomy. This assumes you have already [Created a Model](../create.mdx), and [Created a Taxonomy](create.mdx) for that model.
