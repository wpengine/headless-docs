...
Select the **Create app** button. As you work through the deployment wizard, Atlas verifies that you have the following:
...
Select **Create app** to continue. The wizard then asks for the following information:
