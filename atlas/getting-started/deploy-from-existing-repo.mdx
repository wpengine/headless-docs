...
By default, the Atlas platform will run `npm run build` and `npm run start` to build and start your application. If you want to run different commands to build or start your application, you can reference the docs on [custom build commands](https://developers.wpengine.com/docs/atlas/customization/builds#custom-build-commands) or [custom start commands](../customization/builds#custom-start-commands) to review the various ways this can be implemented. 
