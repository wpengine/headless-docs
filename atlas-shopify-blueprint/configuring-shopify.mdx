...
In order to list products from your **Shopify** store in the Blueprint once it has been deployed, you need to add your Shopify Access Token and Shopify GraphQL URL as Environment Variables.
