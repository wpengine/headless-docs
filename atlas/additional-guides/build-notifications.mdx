...
If you wish to receive an e-mail update once this happens, make sure you configure your respective supported repository hosting service provider (GitHub, GitLab or Bitbucket) settings for this notification accordingly. Here is the [GitHub equivalent](https://docs.github.com/en/account-and-profile/managing-subscriptions-and-notifications-on-github/setting-up-notifications/configuring-notifications#customizing-your-email-notifications):
