...
To deploy your project to Atlas, it will need to be available on a remote GitHub or Bitbucket repository. The Astro installation process lets to initialize a local repository for the project.
...
$ git remote add origin https://<gitprovider>/<username>/<repo>
...
Once your project is in a remotr repository, you can follow [the directions in our getting started guide](https://developers.wpengine.com/docs/atlas/getting-started/deploy-from-existing-repo) to deploy your project to Atlas.
