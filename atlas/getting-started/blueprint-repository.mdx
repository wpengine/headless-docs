...
Please note: at the moment, Blueprints are not available to be used with Bitbucket accounts. However, the Atlas team is actively working on this integration.
...
2. Select one of the blueprints and press `Continue`.
