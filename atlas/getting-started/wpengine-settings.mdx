...
2. Select a region for your application. The region you select will be used for all environments within the application and cannot be changed once your Atlas application deploys.
