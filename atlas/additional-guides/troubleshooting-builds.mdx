...
The logging output pane labeled `Logs` provides you with a record of more general console output. This section captures all of the logging output from your build.
