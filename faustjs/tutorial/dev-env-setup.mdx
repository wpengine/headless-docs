---
slug: /faustjs/tutorial/dev-env-setup
...
WordPress is a content management system (CMS) that allows you to create a website with themes/plugins/etc. It is one of the most popular CMSs in the world, and it is used by over 40% of all websites.

### What is Headless?

Up until recently, WordPress was exclusively used to build monolithic websites. Meaning, the frontend and backend were both tightly coupled via themes and plugins. This has started to change recently with the popularity of Headless.
