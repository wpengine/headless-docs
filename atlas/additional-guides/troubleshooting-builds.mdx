...
After you've pushed a failing build, there are quick ways to start troubleshooting your app from the Atlas dashboard by inspecting the commit or looking at the build logs directly.
...
**Please note:** It's not possible to create a Blueprint application using Bitbucket or GitLab repository at the moment.
