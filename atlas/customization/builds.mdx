...
If for any reason you want to regenerate the webhook ULRs so that old URL will no longer trigger rebuilds, click the `Regenerate all` button and confirm your action:
