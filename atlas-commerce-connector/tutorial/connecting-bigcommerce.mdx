...
**Note**: These tutorials assume that you have already installed the [Atlas Commerce Blueprint via our User Portal](../introduction.mdx)
...
1. Navigate to the **Configuration** menu item under **BigCommerce Connection** in the WP Admin toolbar.
...
**Next step:** [Performing Product Sync](../performing-product-sync.mdx)
