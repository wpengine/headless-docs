...
Once there, scroll down to the "Password protection" section and turn the feature on with toggle:
...
Once redeploy is complete, your sites will be protected with the specified password. Upon login, the cookie will be persisted for the next 24 hours, so while this cookie is valid, you won't be asked to retype the password (as long as you're accessing your site from the same browser).
