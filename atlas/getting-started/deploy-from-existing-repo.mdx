...
Now that you have [chosen to deploy from an existing repository](./blueprint-repository), you can select the repository and deploy it to Atlas. Pushing to the branch of your choice in GitHub will then deploy updates to Atlas automatically.
