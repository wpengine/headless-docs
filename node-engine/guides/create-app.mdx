...
1. Create a new Next.js app from our [getting-started project](https://github.com/wpengine/faustjs/tree/canary/examples/getting-started). Open your Terminal application and enter:

   ```bash
   $ npx create-next-app -e https://github.com/wpengine/faustjs/tree/canary --example-path examples/getting-started --use-npm
   ```
...
Next, let's [deploy the app](./deployment) to the Headless Platform. :rocket:
