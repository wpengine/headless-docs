...
Press “Start with Blueprint” and “Continue”, then select a Blueprint to use and click “Continue”:
...
Whether you start from a blueprint or pull from a repo, you'll then need to set your repo settings:
