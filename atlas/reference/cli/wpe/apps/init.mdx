---
slug: /node-engine/reference/cli/wpe/apps/init
title: wpe apps init
description: Atlas Node Engine API Reference - Generate a wpe.json file for deploying a new WP Engine Headless Application
---
