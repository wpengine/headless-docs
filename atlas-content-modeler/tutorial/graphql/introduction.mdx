...
1. Click on the triple dot menu next to a model and click **Open in GraphiQL** 
    ...
    ![Atlas Content Modeler sync](../../images/Screen_Shot_2021-09-01_at_12.10.01_PM.png)

1. You will be taken to the GraphiQL screen for the chosen model

    ![Atlas Content Modeler sync](../../images/Screen_Shot_2021-09-01_at_12.09.05_PM.png)
