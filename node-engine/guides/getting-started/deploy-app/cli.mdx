...
Before you being, install [the Atlas CLI](../../#install-the-atlas-cli) and ensure that you have created your [first app](../create-app).
...
`domains` can be added to your production environment, but for the purposes of this guide, we won't add a custom domain. For instructions on how to add a custom domain in a production environment, see [Introduction > WP Headless Concepts > Apps and Environments](../../#apps-and-environments).
