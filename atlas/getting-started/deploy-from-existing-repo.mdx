...
After Atlas connects to your account, the `Connected` label with green checkmark indicates that you are connected. A list of repositories associated with your GitHub account appears.
