...
During the installation process, you can select WordPress as a CMS option, and Gatsby will pre-install a few things for you. Reference the section below for what needs to be installed in WordPress for Gatsby to use it.
