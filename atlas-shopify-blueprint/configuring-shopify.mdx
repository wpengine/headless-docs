...
- `NEXT_PUBLIC_SHOPIFY_HEADLESS_PUBLIC_ACCESS_TOKEN`: See [Getting started with public access](https://shopify.dev/docs/api/usage/authentication#getting-started-with-public-access)
- `NEXT_PUBLIC_SHOPIFY_GRAPHQL_URL`: See [Storefront API Endpoints](https://shopify.dev/docs/api/storefront#endpoints)
...
**Note**: If you are not seeing products listed after a rebuild, please clear the cache in your browser or in the Atlas Dashboard itself. [See here for more detailed tips on troubleshooting builds &#8594;](https://developers.wpengine.com/docs/atlas/additional-guides/troubleshooting-builds)
