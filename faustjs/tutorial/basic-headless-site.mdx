---
slug: /faustjs/tutorial/basic-headless-site
...
<img
  src="../assets/img/localwp-create-site.png"
  alt="Red arrow pointing to the create site button in Local"
/>

Follow the onboarding process to create a new WordPress site.

<img src="../assets/img/localwp-site-created.png" alt="Created site settings in Local" />

You can then click the **Open Site** button and visit your new WordPress site directly.

<img src="../assets/img/localwp-site-created-preview.png" alt="WordPress site created using Local" />
