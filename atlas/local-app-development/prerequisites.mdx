...
Once you have all of the prerequisites met, you can proceed to [WordPress Site Configuration](./wordpress-site-configuration).
...
If you're unsure whether you have SSH keys set up already, you can follow these GitHub guides:
