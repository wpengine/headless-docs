...
Atlas Commerce Blocks lets you place product content synced from BigCommerce in your WordPress content using the WordPress editor data from BigCommerce into WordPress. Using the familiar blocks editor, you can build pages and posts with product content.
