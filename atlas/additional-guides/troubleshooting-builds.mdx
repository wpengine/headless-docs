...
### In case the process of creating an application from an Atlas Blueprint fails

1. If you selected to create a repository within an organisation, make sure the GitHub user you're authenticated as has enough permissions to create new repositories in this GitHub org.
...
3. <img width="626" alt="image" src="https://user-images.githubusercontent.com/15729608/178017600-27e4a0cd-14e1-4312-8489-7d424bec26d7.png">
