...
On this page, you'll learn how to set up an app environment. A single Atlas app can have several environments associated with it (one for production, one for stating, etc.).
