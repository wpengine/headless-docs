...
To deploy your project to Atlas, it will need to be available on a remote GitHub or Bitbucket repository. The Gatsby installation process initializes a local repository for the project.
