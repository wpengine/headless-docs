...
Atlas supports three repository hosting service providers - GitHub or Bitbucket. Connect your respective account so you can select the repository to deploy to Atlas.
...
![Connected to provider](./assets/img/github-bitbucket-gitlab.png)
