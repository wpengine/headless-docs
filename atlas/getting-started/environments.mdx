...
description: Configure the environments and variable for your Atlas application.
---
...
For the purposes of this tutorial, we'll create a production environment with the `main` branch.

## Set up your environment

1. From the list of your repository's branches, select the branch you want to use for the basis of you environment. 

   ![Select a branch](../assets/img/select-branch.png)

2. Fill in a name for your Atlas environment. The name should match how you intend to use the environment. For example, if you intend to use the environment only for development purposes, enter `dev`. 
...
3. Every headless environment is associated with a WordPress environment via the site environment name. Choose either:
   ...
   - **I want to create a new WordPress environment**: WP Engine createa new WordPress site and links it to your application. In the box, enter a name for your new WordPress site.
...
The Atlas app details page appears. When Atlas complete building your application, three checkmarks appear under **Last Build**. To see your deployed Atlas appliction, select the **Atlas URL**. You should see your headless application in action!
