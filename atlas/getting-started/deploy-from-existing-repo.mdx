...
3. Create a `ATLAS_BUILD_SCRIPT` environmental variable in the User Portal, with the command to be run as its value. Learn more about environmental variables [here](#env-var).
