...
<img
  src="../assets/imglocalwp-create-site.png"
  alt="Red arrow pointing to the create site button in Local"
/>

Follow the onboarding process to create a new WordPress site.

<img src="../assets/imglocalwp-site-created.png" alt="Created site settings in Local" />

You can then copy the "Site Domain" and visit your new WordPress site directly.

<img src="../assets/imglocalwp-site-created-preview.png" alt="WordPress site created using Local" />
