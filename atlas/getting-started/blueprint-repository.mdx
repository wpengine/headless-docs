...
Note - at the moment, it's not possible to create an application from a Blueprint using Bitbucket or GitLab.

1. Press `Start with Blueprint` and `Continue`.
2. Select the blueprint you would like to use and press `Continue`.
