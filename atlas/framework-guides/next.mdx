...
To deploy your project to Atlas, it will need to be available on a remote GitHub, Bitbucket or GitLab repository.. The Next.js installation process lets us initialize a local repository for the project.
