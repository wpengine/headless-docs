---
slug: /node-engine/reference/cli/wpe/completion/zsh
title: wpe completion zsh
description: Atlas Node Engine API Reference - Print terminal completions for zsh.
---
