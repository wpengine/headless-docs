...
The Reverse Relationship option in Relationship Field is used to display the corresponding linked model in the publisher side of the application for that particular model.
...
1. Give a meaningful name for the Reverse Display Name. Ex. If referencing Cages for a Rabbit model. Name the Reverse Display Name something like **Rabbit Cages**. The **Reverse API Identifier** is auto generated but can be named whatever you would like.
