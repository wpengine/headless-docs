---
slug: /node-engine/guides/headless-concepts
title: WP Engine Headless Concepts
description: Learn a few headless WordPress concepts essential for using Node Engine.
---
...
- `environments` - an array of environments that your app contains. Each environment is deployed to Atlas and receives a unique URL.
