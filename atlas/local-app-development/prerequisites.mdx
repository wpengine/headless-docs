...
Once you have all of the prerequisites met, you can proceed to [WordPress Site Configuration](./wordpress-site-config).
...
While the examples in this guide use the command line to interact with Git and GitHub, the UI-based [GitHub Desktop app](https://docs.github.com/en/get-started/using-github/github-desktop) is a viable alternative to managing your repository from the command line. 
