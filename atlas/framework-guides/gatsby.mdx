...
Create a new remote repository at [repo.new](https://repo.new), and then run the following commands to initialize and configure your local and remote repositories:
```
