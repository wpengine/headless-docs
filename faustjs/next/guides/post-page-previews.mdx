...
title: Setting Up Post/Page Previews
description: View WordPress preview post/page content on your headless frontend with Faust.js
---

# Setting Up Post/Page Previews

Faust.js has support for page/post previews. This allows you to view your WordPress content on the headless frontend as drafts or even before publishing.
...
### Add the headless secret to your `.env` file
...
### Ensure the headless secret is being passed to `headlessConfig`
