...
If any of the above folders are in the projects root directory at the start of the build, the cache will **not** override them. 

Performing a clean rebuild will remove any previously cached files. 