...
To make your Atlas workflow easier, you can now dynamically create new Atlas environments to test your changes, without having to go through all the configuration steps in the User Portal.
